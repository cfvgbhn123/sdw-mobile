...
_indexView.$nextTick(function () {
    ...
    if (SDW_WEB.channel == '10041') {
        ...
        if (!hasShowSB) {
            ...
            ifm.src = 'http://www.shandw.com/h5/cigarette/dialog.html?v=' + SDW_WEB.version;
            ifm.id = 'sbmh';
            ...
            window.addEventListener('message', function (e) {
                try {
                    ...
                    if (postData.oprate == 'goBack') {
                        location.href = 'http://www.shandw.com/h5/cigarette/?v=' + SDW_WEB.version;
                    }
