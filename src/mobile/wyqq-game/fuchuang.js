...
(function ($) {
    ...
    var activityOpenFlag = checkActivity();
    ...
    var methods = {
        ...
        loadServerGame: function () {
            ...
            var getUri = HTTP_STATIC + 'wyqqserverinfo?type=' + type;
        ...
        getGamesInfo: function (option) {
            ...
            if (isSimple) {
                ...
                var postUri = SDW_WEB.URLS.addParam({
                    ...
                    type: option.type,
                    page: option.page
                }, false, HTTP_STATIC + 'wyQuanQuanGameList');
            }
        ...
        goToGames: function (item, url) {
            ...
            setTimeout(function () {
                ...
                dialog.hidden();
                var goUrlParam = {
                    channel: SDW_WEB.channel, // 优先取SDW中的准确channel
                };

                var MOBILE_GAME = 'http://www.shandw.com/wyqq/game/APP_ID.html';
                var Url = MOBILE_GAME.replace(/APP_ID/, item.id || item.gid);
